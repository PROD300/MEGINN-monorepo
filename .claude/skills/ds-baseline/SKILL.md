---
name: ds-baseline
description: Поставить стартовую дизайн-систему на пустой проект — бриф из пяти вопросов, ds/foundation.md с двумя слоями токенов, две коллекции Figma Variables («Primitive» и «Semantic»), SectionNode «Foundation» рядом с Wireframes плюс 5–7 базовых компонентов, ссылающихся на смысловые Variables, и контракт ds/CONTRACT.md, закрепляющий правила работы с ДС в проекте. Используй, когда в проекте ещё нет дизайн-системы и её нужно поставить с нуля одним прогоном.
