...
- Competitive analysis and heuristic audit of the market
- Personas, metrics, and MVP scope: 13 prioritized features
- Full product architecture: 17 screens

## 2. UI

- Production-grade design system built on a strict token and component contract
- Dark theme, unified accent color, tabular-figure typography for financial data
- Every app screen and the landing page assembled from the design system

## 3. Development and Deployment

- Monorepo with preserved code history
- Deployed on Vercel: app and landing page as separate live links
- Controlled change process: dev preview → approval → commit
